...
var _fabu_huadong = _interopRequireDefault(__webpack_require__(/*! ./pages/fabu_huadong/fabu_huadong.vue */ 94));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _fabu_huadong_vue_vue_type_template_id_47da7b66_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fabu_huadong.vue?vue&type=template&id=47da7b66&scoped=true& */ 95);
/* harmony import */ var _fabu_huadong_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fabu_huadong.vue?vue&type=script&lang=js& */ 97);
...
/* harmony import */ var _fabu_huadong_vue_vue_type_style_index_0_id_47da7b66_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fabu_huadong.vue?vue&type=style&index=0&id=47da7b66&scoped=true&lang=css& */ 99);
...
var that;var _default = { data: function data() {return { id: '', problem: { "title": "", "img": [] }, "type": "5", //问题类别1：单选题  2：多选题  3：填空题  4：排序题  5：滑动题
      "answer": { "min_num": "0", "min_text": "不好", "max_num": "100", "max_text": "非常好", "step_size": "1" } };}, onLoad: function onLoad(option) {that = this;if (option.type) {this.type = option.type;} else {this.type = 5;}}, onShow: function onShow() {}, computed: _objectSpread({}, (0, _vuex.mapState)(['new_xz'])), methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)(['setnew_problem', 'setnew_xz'])), {}, { sub: function sub() {var that = this;if (!this.problem.title) {uni.showToast({ icon: 'none', title: '请输入标题' });return;}
